...
import {AddAdress,EditAdre} from '../backend/Api';
...
class EditAddress extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            location:this.props.route.params.item.flat,
            add: '',
            lat: 0,
            long: 0,
            height:40,
            ...
            mobile:this.props.route.params.item.phone,
            visible:false,
            city:[],
            selectedcity:this.props.route.params.item.location,
            area:'',
            visibles:false,
            arearray:[],
            pincode:'',
...
if (this.state.name.length == 0){
  ...
  EditAdre({name: this.state.name,phone:this.state.mobile,flat:this.state.location,latitude:this.state.lat.toString(),longitude:this.state.long.toString(),location:this.state.selectedcity,id:this.props.route.params.item.id})
    .then((data) => {
